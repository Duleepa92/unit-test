...
describe('demo', ()=> {
    ...
    context('should test a promise with return', ()=> {
    ...
    context('test doubles', ()=> {
        ...
        it('should stub console.worn', ()=> {
            let stub = sinon.stub(console,'warn').callsFake(()=> {console.log('message from stub')});
            demo.foo()
            expect(stub.calledOnce).to.be.true;
            expect(stub.calledWith('console.warn was called'));
            stub.restore();
        })
    })

    context('stub privae function', ()=> {
        it('should stub createFile', async ()=> {
            ...
            expect(result).to.be.equal('calldb_stub');
            expect(createStub.calledOnce).to.be.true;
            expect(createStub.calledWith('test.txt'));
